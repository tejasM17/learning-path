...
function EditBook() {
  ...
  useEffect(() => {
    const fetchBook = async () => {
      try {
        ...
        setFormData({
          name: data.book.name || '',
          Discription: data.book.Discription || '',
          Price: data.book.Price || '',
          authour: data.book.authour || '',
  ...
  return (
    <Layout>
      ...
      >
        <FormHeader>
          <BackLink to={`/books/${bookId}`}>← Back to Book Details</BackLink>
          <FormTitle variants={itemVariants}>Edit Book</FormTitle>
        </FormHeader>
